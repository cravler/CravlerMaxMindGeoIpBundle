        ...
        $rootNode
            ->children()
                ...
                ->arrayNode('source')
                    ...
                    ->children()
                        ->scalarNode('country')
                            ->defaultValue('https://geolite.maxmind.com/download/geoip/database/GeoLite2-Country.mmdb.gz')
                        ->end()
                        ->scalarNode('city')
                ...
                ->arrayNode('md5_check')
                    ...
                    ->children()
                        ->scalarNode('country')
                            ->defaultValue('https://geolite.maxmind.com/download/geoip/database/GeoLite2-Country.md5')
                        ->end()
                        ->scalarNode('city')
                            ->defaultValue('https://geolite.maxmind.com/download/geoip/database/GeoLite2-City.md5')
                        ->end()
                        ->scalarNode('connection_type')
                            ->defaultValue(null)
                        ->end()
